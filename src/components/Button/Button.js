...
export const Button = ({
  ...
  let variantColors = "bg-[#9052F4] hover:bg-[#a675f4]";
  ...
  if (variant === "tertiary") variantColors = "bg-secondary";
    ...
    } ${variantColors} duration-200 text-md text-custom-gray rounded-md text-center px-4 py-2 md:text-xl font-semibold transition-all hover:scale-[1.03] ${variant === 'primary' ? 'text-white' : ''} ${classnames}`;
